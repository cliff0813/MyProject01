;(function (w, d) {
  ...
  var beaconList = [{
    ...
    genData: function (env) {
      return function (a,b,c) {
        //
        var _PN = '';
        var title1 = '';var title2 = '';var picUrl = '';

        if (a) { title1 = a;} else { title1 = '最新優惠報你知！即時熱門優惠訊息!';}
        if (b) { title2 = b;} else { title2 = '最新產品優惠情報、熱門活動，即時訂閱讓你不錯失任何優惠訊息。';}
        if (c) { picUrl = c;} else { picUrl = 'https://notify.accunix.net/discount.png';}
        var content = {
          text: 'Web notify Test',
          buttonText: '同意',
          buttonLink: 'https://notify.accunix.net/' + env.hostname + '/?fpc=' + env.fpc + '&source='+env.hostname,
          cookieExpiration: 30,
        ...
        var helloBar = '<div id="hellobar-bar" class="web-notify-wrapper"><div class="web-notify-content"><div class="web-notify-content-img"><img src="'+picUrl+'"></div><div class="web-notify-content-text"><div class="web-notify-content-title">'+title1+'</div><div class="web-notify-content-discount">'+title2+'</div></div><div class="web-notify-content-button"><a class="web-notify-content-cancel-button">取消</a><a onclick="window.open(\''+content.buttonLink+'\', \'Yahoo\', config=\'height=500,width=500,top='+content.top+',left='+content.left+'\');" class="web-notify-content-subscription-button">我要訂閱</a></div></div></div>';
        //
    ...
    name: 'beaconSend',
    url: 'https://kafka-api.accunix.net/cdp-rawevent-bankee',
    genData: function (env) {
    ...
    name: 'beaconJS3',
    url: 'https://kafka-api.accunix.net/cdp-rawdata-bankee',
    genData: function (env) {
  ...
  var domainMappings = {
    allRun: function (env) {
      ...
      if (env.hostname != 'mapping.accunix.net') {
        mapping_accuPrepareFrame(env.fpc, env.hostname)
      }

      AD2_pixel(env)

      loadFBPixel('455769355684849',env.fpc, function (fbq){
